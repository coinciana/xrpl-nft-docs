...
PCでは表示されるQRコードをXamanアプリで読み込みます。  
スマホでは **Xamanアプリ** が立ち上がります。

「**スライドして承認する**」ボタンをスライドして承認することでログインできます。


<img className="solo" src="/manual_pic/02_pic01.png" alt="02_pic01" />
...
<img className="" src="/manual_pic/02_pic02.png" alt="02_pic02" />

### (3) ログインする

画面右上の「**接続（Connect）**」をクリックして立ち上がったウィンドウから「**Connect Xaman**」を選びます。

PCでは表示されるQRコードをXamanアプリで読み込みます。  
スマホでは **Xamanアプリ** が立ち上がります。[^1]
