...
高速・安全・低コストなXRPL NFTの始め方をご紹介します。  
...
### 1.ウォレットを準備する
 ...
 2. [ウォレットを用意する](/02_how_to_start/01_prepare/02_create_wallet)
...
- [xrp.cafeでランダムMintする](/02_how_to_start/03_mint/03_mint_at_xrpcafe_random)
...
- [XRP easy NFT　メモ](/02_how_to_start/08_memo/01_memo_easynft)
- [xrp.cafe　メモ](/02_how_to_start/08_memo/02_memo_xrpcafe)
...
- [xaman pro beta](/03_about/02_memo#xaman-pro-beta有料)
